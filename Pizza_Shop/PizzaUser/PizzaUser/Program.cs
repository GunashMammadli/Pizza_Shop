                                ...
                                Pizzas:
                                    ...
                                    switch (choose3)
                                    {
                                        ...
                                        case 4:
                                            ...
                                            int removeinp = Convert.ToInt32(Console.ReadLine());
                                    ...
                                    OrdP:
                                        ...
                                        switch (chooseor)
                                        {
                                            case 1:
                                                ...
                                                break;
                                            case 2:
                                                Console.WriteLine("Enter 1 if you want to add product to the basket,\n" +
                                                                  "Enter 2 if you want to remove product from the basket.");
                                                int choosebasket = Convert.ToInt32(Console.ReadLine());
                                                switch (choosebasket)
                                                {
                                                    case 1:
                                                        goto OrdP;
                                                    case 2:
                                                        Console.Write("Enter the ID of the pizza you want to remove from the basket: ");
